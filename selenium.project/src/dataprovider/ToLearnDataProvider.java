...
public class ToLearnDataProvider 
{
	...
	{
		String data[][]= {{"admin","admin"},{"user","user"},{"abhis@gmail.com","abhi1234"}};
		return data;
	}
// passing the data from @dataprovider to dataprovider and it is receiving inthe form of String[] cred
//	index start from 0
